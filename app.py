...
with open(DATA_DIR / "majors.json", "r", encoding="utf-8") as f:
    majors_data = json.load(f)

with open(DATA_DIR / "skill_questions.json", "r", encoding="utf-8") as f:
    skill_questions = json.load(f)

with open(DATA_DIR / "simulation_scenarios.json", "r", encoding="utf-8") as f:
